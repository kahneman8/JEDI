...
def compose_and_generate(
 ...
 system_prompt = ("You are a equity research AI assistant tasked with generating a structured morning market brief." "Produce two outputs: first, a JSON object strictly following the provided schema; second, a well-formatted Markdown report."
               "Every statement must end with a citation usin the provided URLs. Do not invent facts.")   
...
JSON schema:
{
 ...
 "news_by_sector": {
 "<Sector>": [
 {"headline": "<text>", "sentiment": "Positive|Negative|Neutral", "source":
"<publisher>", "url": "<url>"}, …
 ], …
 },
...
The Markdown report should mirror the same data with headings and bullets and
citation footnotes.
"""
